...
public class Empleado extends JFrame implements ActionListener, KeyListener, FocusListener, MouseListener, WindowListener, ItemListener {
    ...
    private JPanel mostrarResultados, agregarEmpleado;
    private JLabel tira, tira2, tira3, tira4, rights, consulta, busqueda, por, ordenado, agreEmpleado, id_em, nombre, telefono;
    ...
    public Empleado(String title){
        ...
        //Panel para agregar
        agregarEmpleado=new JPanel();
        agregarEmpleado.setBounds(0,0,810,650);
        agregarEmpleado.setBackground(new Color(255,255,255));
        ...
        String[] header=new String[]{"Id","Nombre","Tel\u00e9fono"};
        ...
        tira.setBackground(new Color(0,153,153));
        tira.setOpaque(true);
        agregarEmpleado.add(tira);

        tira2=new JLabel();
        tira2.setBounds(0,20,810,9);
        tira2.setBackground(new Color(2,199,199));
        tira2.setOpaque(true);
        agregarEmpleado.add(tira2);

        tira3=new JLabel();
        tira3.setBounds(0,29,810,7);
        tira3.setBackground(new Color(0,220,220));
        tira3.setOpaque(true);
        agregarEmpleado.add(tira3);

        tira4=new JLabel();
        tira4.setBounds(0,36,810,4);
        tira4.setBackground(new Color(0,243,243));
        tira4.setOpaque(true);
        agregarEmpleado.add(tira4);
        ...
        rights.setBackground(new Color(0,0,0));
        rights.setForeground(new Color(255,255,255));
        agregarEmpleado.add(rights);

        agreEmpleado=new JLabel("Agregar empleado");
        agreEmpleado.setBounds(100, 80, 300, 60);
        agreEmpleado.setForeground(blue);
        agreEmpleado.setFont(new Font("Microsoft New Tai Lue", 1, 20));
        agregarEmpleado.add(agreEmpleado);

        id_em=new JLabel("Id Empleado");
        id_em.setBounds(100, 180, 150, 30);
        id_em.setForeground(new Color(0,0,0));
        id_em.setFont(new Font("Microsoft New Tai Lue", 0, 18));
        agregarEmpleado.add(id_em);
        ...
        agregarEmpleado.add(id_txt);

        nombre=new JLabel("Nombre");
        nombre.setBounds(100, 280, 70, 30);
        nombre.setForeground(new Color(0,0,0));
        nombre.setFont(new Font("Microsoft New Tai Lue", 0, 18));
        agregarEmpleado.add(nombre);

        nombre_txt=new JTextField();
        nombre_txt.setBounds(200,277,470,30);
        ...
        agregarEmpleado.add(nombre_txt);

        telefono=new JLabel("Tel\u00e9fono");
        telefono.setBounds(100, 380, 100, 30);
        telefono.setForeground(new Color(0,0,0));
        telefono.setFont(new Font("Microsoft New Tai Lue", 0, 18));
        agregarEmpleado.add(telefono);

        telefono_txt=new JTextField();
        telefono_txt.setBounds(200,377,200,30);
        ...
        agregarEmpleado.add(telefono_txt);
    ...
    public void actionPerformed(ActionEvent evt){
        if(evt.getSource() == this.agregar){
            ...
            this.agregarEmpleado.setVisible(true);
